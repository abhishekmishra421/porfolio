    ...
    <div class="col-12">
        <div class="admin-card">
            <div class="admin-card-header">
                <h5><i class="fas fa-plus me-2" style="color:var(--primary)"></i>Category Details</h5>
            </div>
            <div class="admin-card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" value="<?php echo set_value('name'); ?>" required placeholder="e.g. Web Design, PHP, Logo Design">
